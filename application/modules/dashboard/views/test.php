            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title" style="margin-left: 15px">Add Supervisor</h4>
                </div>
                <div class="card-body">
                 <?php echo form_open('dashboard/reporting_data/'.$user_id) ?>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                            <? if(isset($report)){ ?>  <label ><b>Select Reporting Supervisor</b></label><br>
                               <?php
